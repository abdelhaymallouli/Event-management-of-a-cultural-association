...
$query = 'SELECT e.eventId, ed.editionId, e.eventTitle AS event_title, e.eventDescription AS event_description, 
          ...
          -- WHERE ed.dateEvent >= CURDATE() -- Commented out to show all events (debug mode)
          ';
            ...
            <div class="search-bar">
                <form action="" method="get">
                    ...
                    <select name="category">
                        ...
                        <option value="Musique" <?php if ($category == 'Musique')
                            echo 'selected'; ?>>Musique</option>
                        <option value="Théatre" <?php if ($category == 'Théatre')
                            echo 'selected'; ?>>Théatre</option>
                        <option value="Cinéma" <?php if ($category == 'Cinéma')
                            echo 'selected'; ?>>Cinéma</option>
                        <option value="Rencontres" <?php if ($category == 'Rencontres')
                            echo 'selected'; ?>>Rencontres
                        </option>
                    ...
                    <div class="event-details">
                        ...
                        <div class="event-organizer">
                            ...
                            <?php if ($remainingTickets <= 0): ?>
                                ...
                                <a href="event.php?eventId=<?php echo $event['eventId']; ?>&editionId=<?php echo $event['editionId']; ?>"
                                    class="buy-now-btn-soldout">BUY NOW</a>
                            <?php else: ?>
                                <a href="event.php?eventId=<?php echo $event['eventId']; ?>&editionId=<?php echo $event['editionId']; ?>"
