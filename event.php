    ...
    <div class="sidebar">
      ...
      <div class="card">
        ...
        <div class="calendar-option">
          <img class="calendar-icon" src="/api/placeholder/20/20" alt="Google">
          <span>Google</span>
        </div>
        
        <div class="calendar-option">
          <img class="calendar-icon" src="/api/placeholder/20/20" alt="Yahoo">
          <span>Yahoo</span>
        </div>
        
        <div class="calendar-option">
          <img class="calendar-icon" src="/api/placeholder/20/20" alt="Apple">
          <span>Apple</span>
        </div>
        
        <div class="calendar-option">
          <img class="calendar-icon" src="/api/placeholder/20/20" alt="Outlook">
          <span>Outlook</span>
        </div>
      </div>
    </div>
